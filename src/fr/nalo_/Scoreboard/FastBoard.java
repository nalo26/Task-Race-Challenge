...
public class FastBoard {
    ...
    private static String getColorCode(int score) {
    ...
    private static void setField(Object object, Class<?> fieldType, Object value, int count) throws ReflectiveOperationException {
        int i = 0;
